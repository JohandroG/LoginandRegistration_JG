...
class User:
    ...
    def add_user(cls,newuserinfo):
        ...
        results = connectToMySQL('loginform').query_db(query,dataFromForm)
        return results
    ...
    def validatelogin(cls,loginInfo):
        ...
        results = connectToMySQL('loginform').query_db(query,email)
        return results
    ...
    def get_by_id(cls,data):
        ...
        results = connectToMySQL('loginform').query_db(query,data)
    ...
    def validateregistry(data):
        ...
        results = connectToMySQL('loginform').query_db(query,emaildata)
        print(results)
